                ...
                <div class="max-w-screen flex flex-wrap items-center justify-between mx-auto px-4 py-2 md:mx-20">              
                    ...
                    <div className="sm:order-2 md:order-3 flex flex-row gap-4 items-center sm:float-right ml-auto lg:ml-0">
                        ...
                        <div className="flex flex-row md:order-2 gap-4">
                            ...
                            <Link to="/cart" class="flex items-center space-x-3 rtl:space-x-reverse font-md order-2">
                            ...
                            {isAuthenticated &&  <AccountDropdown></AccountDropdown>}
                            {!isAuthenticated && <Link to="/lookup" state={{from: location.pathname}} class="flex items-center space-x-3 rtl:space-x-reverse font-bold order-2">
                    ...
                    <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                            ...
                            <ul class="relative left-30 font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                                <li>
