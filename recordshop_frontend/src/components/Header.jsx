    ...
    return (
        <>        
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <span>
                    <Link to="/your-account" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Profile Logo" />
                    </Link>
          
                <Link to="/cart" class="flex items-center space-x-3 rtl:space-x-reverse text-white">
                    {CartItemQuantity}
                </Link>
                </span>
