...
const Card = ({album, style = "regular"}) => {
    ...
    return <>
    <Link to={cardURL} >
    <article className="w-[7rem]  md:w-[15rem] ">
            <div className={"mb-2 overflow-hidden " + (style === "rounded" ? "rounded-full sm:w-[7rem] sm:h-[7rem] md:h-[13rem] md:w-[13rem]" : "rounded-lg w-full h-full") }> 
